...
#Create core/flake and bipolar columns
...
arc_data <- read_csv("../data/arc_data.csv")
...
experiment_data <-
  read_csv("../data/experiment_data.csv", 
           na = c("NA", "", '<NA>'))
...
#plot windows
par(mfrow = c(2, 2))
plot_fns %>% invoke_map(,fits, legendtext = dists)
...
plot(series_2_shape_gamlss1, par = newpar)
```
...
tool_event_coords_subset <- read_csv("../data/tool_three_event_movement.csv")
